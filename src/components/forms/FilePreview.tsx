  ...
  return imagesType.includes(file.type) ? (
      ...
      >
        ...
        <div className='ml-4 flex flex-shrink-0 items-center space-x-2'>
          <button
            ...
            className='focus:ring-primary inline-block rounded text-xl font-medium text-gray-500 hover:text-gray-700 focus:outline-none focus:ring'
          >
            <HiOutlineEye />
          </button>
          {!readOnly && (
    ...
    >
      ...
      <div className='ml-4 flex flex-shrink-0 items-center space-x-2'>
        <UnstyledLink
          href={file.preview}
          className='focus:ring-primary rounded text-gray-500 hover:text-gray-700 focus:outline-none focus:ring'
        >
