...
export const SidebarWrapper = () => {
  ...
  return (
    <aside className="sticky top-0 z-50 h-full">
      ...
      <div
        className={cn(
          "fixed z-[202] h-full w-64 shrink-0 -translate-x-full flex-col overflow-y-auto border-r border-divider bg-content1 px-3 pb-6 transition-transform md:static md:ml-0 md:flex md:h-screen md:translate-x-0 ",
